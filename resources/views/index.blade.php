...
@section('content')
    ...
    <ul>
        ...
        <li>
            <font color="blue">GET</font> : <b>"/metricks/{site}"</b> - 
            получение списка всех снятых метрик с конкретного сайта {site}.
            Представлено в виде постраничной таблицы со всеми необходимыми данными.
        </li>
        <li>
        ...
        <li>
            <font color="blue">GET</font> : <b>"/metricks/{site}/stat"</b> - 
            получение графика зависимости колличества кликов от временного промежутка в течении дня с конкретного сайта {site}.
        </li>
        <li>
